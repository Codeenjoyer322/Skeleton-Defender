    ...
    public static class BalanceV062Tests
    {
        ...
        public static void Run()
        {
            ...
            try
            {
                ...
                Call(model, "UpdateEnemyAbility", firstOwner, 3f);
                ...
                Call(model, "UpdateEnemyAbility", secondOwner, 3f);
                ...
                Call(model, "UpdateEnemyAbility", firstOwner, 30f);
                ...
                for (int i = 0; i < 5; i++) Call(legacy, "UpdateEnemyAbility", unlimited, 3f);
